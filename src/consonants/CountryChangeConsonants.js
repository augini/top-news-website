...
export const RUSSIA = {
  ...
  categories: ['Все', 'Экономика', 'Культура', 'Здоровье', 'Наука и техника', 'Спорт', 'Технология'],
  countries: ['США', 'Россия', 'Корея']
}

export const KOREA = { 
  data: KOREACollection,  
  categories: ['최신기사', '경제', '연예', '건강 ', '과학 ', '스포츠', '기술'],
  countries: ['미국', '러시아', '대한민국']
} 

export const countriesList = [['USA', 'США','미국',], ['RUSSIA','Россия','러시아'], ['KOREA','Корея', '미국']]